...
namespace Microsoft.Xna.Framework.Graphics.Fade
{
	...
	internal class SpriteBatcher
	{
        ...
        private FadeSpriteVertex[] _vertexArray;
        ...
        private unsafe void EnsureArrayCapacity(int numBatchItems)
        {
            ...
            _vertexArray = new FadeSpriteVertex[4 * numBatchItems];
        }
        ...
        public unsafe void DrawBatch(SpriteSortMode sortMode, Effect effect)
		{
            ...
            while(batchCount > 0)
            {
                ...
                fixed (FadeSpriteVertex* vertexArrayFixedPtr = _vertexArray)
                {
            ...
            if (effect != null)
            {
                ...
                foreach (var pass in passes)
                {
                    ...
                    _device.DrawUserIndexedPrimitives(
                        ...
                        0,
                        (vertexCount / 4) * 2,
                        FadeSpriteVertex.VertexDeclaration);
                }
            }
            else
            {
