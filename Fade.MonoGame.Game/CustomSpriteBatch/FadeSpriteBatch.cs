...
{
    public struct SpriteTexCoord1
    {
        public Vector4 tl, tr, bl, br;

        public SpriteTexCoord1(Vector4 t)
        {
            tl = tr = bl = br = t;
        }
    }
	...
	public class SpriteBatch : GraphicsResource
	{
        ...
        public SpriteBatch(GraphicsDevice graphicsDevice, FadeSpriteEffect customEffect) : this(graphicsDevice, customEffect, 0)
        {            
        }
...
case SpriteSortMode.Texture:
    ...
    break;
                ...
                float layerDepth)
		{
            ...
            Draw(texture, position, sourceRectangle, color, rotation, origin, scaleVec, effects, layerDepth, new SpriteTexCoord1());
		}
